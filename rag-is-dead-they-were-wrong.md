...
## Hook #1: Let me tell you about the $47,000 mistake.
...
Suddenly, your entire codebase fits in context. Your entire customer support history fits. Your company's complete documentation—from founding to present—fits.
...
- 1M tokens input × $3 per million tokens (Claude 3.5 Sonnet pricing) = $3 per query
- 1,000 queries/day = $3,000/day = $90,000/month

**Option B: Smart Retrieval + Context**
- Retrieve top 5 relevant tickets (5K tokens) + generation (1K tokens) = 6K tokens
- 6K tokens × $3 per million = $0.018 per query
- 1,000 queries/day = $18/day = $540/month
...
- 4K context: 2.3 seconds response time
- 32K context: 8.7 seconds
- 200K context: 47 seconds
- 1M context: "Go get coffee, maybe lunch"
...
1. **Level 1:** Document-level summaries (100 tokens per doc)
2. **Level 2:** Section summaries (200 tokens per section)
3. **Level 3:** Detailed chunks (500 tokens per chunk)

**The workflow:**
- Query matches against Level 1 summaries first
- Promising documents get their sections retrieved (Level 2)
- Finally, specific chunks from relevant sections (Level 3)
...
**Example:**
- Original retrieved chunk: 500 tokens of legal text with boilerplate
- Compressed context: 150 tokens of essential facts
...
- **[SYSTEM INSTRUCTIONS]** — Position: Start
- **[CORE RELEVANT CONTEXT]** — Position: Start/Middle
- **[SECONDARY CONTEXT]** — Position: Middle
- **[EXAMPLES/FEW-SHOT]** — Position: End
...
**Latency impact:** 3 sequential calls might sound slower, but each is fast. Total time: 8 seconds. Single 1M token call: 47 seconds.
